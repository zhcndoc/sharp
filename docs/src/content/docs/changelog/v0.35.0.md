...
* 破坏性变更：移除 `install` 脚本。
  如果预构建的平台特定二进制文件不可用，请手动使用
  [WebAssembly](https://sharp.pixelplumbing.com/install/#webassembly) 或
  [从源码构建](https://sharp.pixelplumbing.com/install/#building-from-source)。
